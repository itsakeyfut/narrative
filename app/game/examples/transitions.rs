//! All Transitions Demo Example
//!
//! This example demonstrates ALL scene transition effects including:
//! - Fade (black), FadeWhite
//! - Crossfade
//! - Slide (Left, Right, Up, Down)
//! - Wipe (Left, Right, Up, Down)
//! - Dissolve
//!
//! Run with: cargo run --example transitions
...
fn main() -> anyhow::Result<()> {
    ...
    tracing::info!("Starting All Transitions Demo");

    // Create and run GUI application
    App::new(WindowOptions {
        title: "All Transitions Demo - Narrative Engine".to_string(),
        width: 1280,
        height: 720,
    ...
    .with_root(|| {
        ...
        config.window.title = "All Transitions Demo".to_string();
        config.window.width = 1280;
        config.window.height = 720;

        // Create root element with all transitions demo scenario
        Box::new(GameRootElement::with_scenario(
            config,
            "assets/scenarios/examples/transitions.toml",
        ))
    })
