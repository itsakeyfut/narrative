//! Conditions Demo Example
//!
//! This example demonstrates the conditional branching system.
//! It loads the conditions.toml scenario from assets/scenarios/examples/
//! which showcases:
//! - Compound conditions with AND/OR logic
//! - Flag-based branching
//! - Complex conditional expressions
//! - Choice visibility based on conditions
//!
...
fn main() -> anyhow::Result<()> {
    ...
    tracing::info!("Starting Conditions Demo Example");
    ...
    App::new(WindowOptions {
        title: "Conditions Demo - Narrative Engine".to_string(),
        width,
        height,
        resizable: false,
    ...
    .with_root(move || {
        ...
        config.window.title = "Conditions Demo".to_string();
        config.window.width = width;
        config.window.height = height;

        // Load the example conditions scenario
        config.start_scenario =
            std::path::PathBuf::from("assets/scenarios/examples/conditions.toml");
